 ...
 * @param locale 语言参数，影响日期格式（zh/en）
 */

export const getUserMetaphysics = (birthDate: Date, locale: string = 'zh') => {
  ...
  return {
    ...
    week: locale === 'en' ? weekNames[weekDay] : `周${solar.getWeekInChinese()}`,
    // 农历日期：如 二月初二
